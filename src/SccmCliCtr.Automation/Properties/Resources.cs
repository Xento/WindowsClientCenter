// Derived from the upstream Resources.resx and generated Resources.Designer.cs
// in sccmclictrlib commit 1c875c00ab04144741247873cea1b69cb25ef1ea.
// Modified by Windows Client Center contributors in 2026 for the net8.0 port.
// Licensed under LGPL-3.0-or-later. See ../LICENSE.md and ../MODIFICATIONS.md.
...
""";
    ...
    internal static string HealthCheck => LoadEmbeddedText("sccmclictr.automation.Resources.HealthCheck.ps.txt");
...
""";
    ...
    private static string LoadEmbeddedText(string resourceName)
    {
        ...
        using Stream? stream = resolvedName is null
            ? null
