...
//Modified by Windows Client Center contributors in 2026. The example management
//point hostname was sanitized. See MODIFICATIONS.md for the complete record.
...
namespace sccmclictr.automation.policy
{
    ...
    public class localpolicy
    {
        ...
        /// </summary>
        /// <param name="URL">e.g. http://management-point.example.invalid/SMS_MP/.sms_pol?{ce839d51-8469-42b2-ae09-c5a8faaa1ef7}.7_00</param>
        /// <returns>XML Body</returns>
        public static string DownloadPolicyFromURL(string URL)
        {
            //http://management-point.example.invalid/SMS_MP/.sms_pol?{ce839d51-8469-42b2-ae09-c5a8faaa1ef7}.7_00
