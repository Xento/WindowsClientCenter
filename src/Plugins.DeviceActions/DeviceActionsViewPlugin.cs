...
public sealed class DeviceActionsViewPlugin : IViewPlugin, INavigationAwareViewPlugin
{
    private IPluginContext? _context;
    private DeviceActionsViewModel? _viewModel;
    private DeviceActionsView? _view;

    public IPluginManifest Manifest { get; } = new PluginManifest(
        Id: "device-actions-view",
        DisplayName: "Device Actions",
        Version: "1.0.0",
    ...
    public object CreateView()
    {
        ...
        _viewModel ??= new DeviceActionsViewModel(_context);
        _view ??= new DeviceActionsView
        {
